...
std::map<std::string, std::string> StateManager::initStaticMap() {
	...
	std::string adventureState = "{'context':{'partyId1':0,'partyId2':0},'map':{'height':8,'hexes':[{'v':0,'x':0,'y':0},{'v':0,'x':1,'y':0},{'v':0,'x':2,'y':0},{'v':3,'x':3,'y':0},{'v':3,'x':4,'y':0},{'v':3,'x':5,'y':0},{'v':0,'x':6,'y':0},{'v':0,'x':7,'y':0},{'v':1,'x':0,'y':1},{'v':1,'x':1,'y':1},{'v':1,'x':2,'y':1},{'v':1,'x':3,'y':1},{'v':3,'x':4,'y':1},{'v':1,'x':5,'y':1},{'v':1,'x':6,'y':1},{'v':1,'x':7,'y':1},{'v':2,'x':0,'y':2},{'v':2,'x':1,'y':2},{'v':1,'x':2,'y':2},{'v':1,'x':3,'y':2},{'v':2,'x':4,'y':2},{'v':2,'x':5,'y':2},{'v':0,'x':6,'y':2},{'v':2,'x':7,'y':2},{'v':1,'x':0,'y':3},{'v':2,'x':1,'y':3},{'v':1,'x':2,'y':3},{'v':1,'x':3,'y':3},{'v':1,'x':4,'y':3},{'v':2,'x':5,'y':3},{'v':1,'x':6,'y':3},{'v':2,'x':7,'y':3},{'v':0,'x':0,'y':4},{'v':1,'x':1,'y':4},{'v':0,'x':2,'y':4},{'v':2,'x':3,'y':4},{'v':0,'x':4,'y':4},{'v':1,'x':5,'y':4},{'v':0,'x':6,'y':4},{'v':2,'x':7,'y':4},{'v':1,'x':0,'y':5},{'v':2,'x':1,'y':5},{'v':1,'x':2,'y':5},{'v':2,'x':3,'y':5},{'v':1,'x':4,'y':5},{'v':0,'x':5,'y':5},{'v':1,'x':6,'y':5},{'v':2,'x':7,'y':5},{'v':0,'x':0,'y':6},{'v':1,'x':1,'y':6},{'v':0,'x':2,'y':6},{'v':2,'x':3,'y':6},{'v':0,'x':4,'y':6},{'v':1,'x':5,'y':6},{'v':0,'x':6,'y':6},{'v':2,'x':7,'y':6},{'v':1,'x':0,'y':7},{'v':2,'x':1,'y':7},{'v':1,'x':2,'y':7},{'v':2,'x':3,'y':7},{'v':1,'x':4,'y':7},{'v':2,'x':5,'y':7},{'v':1,'x':6,'y':7},{'v':2,'x':7,'y':7}],'scale':1.5,'width':8},'mapObjects':[{'actions':[0,1,6,7,8,9,10],'category':1,'id':1,'items':[{'count':1,'type':1},{'count':10,'type':5}],'layer':2,'members':[{'actions':[0,1],'ap':1,'baseDefense':3,'basePower':3,'baseSkill':2,'equip':null,'hp':10,'id':0,'maxAp':30,'maxHp':10,'owner':1,'visualType':0,'x':1,'y':1},{'actions':[0,2],'ap':6,'baseDefense':1,'basePower':2,'baseSkill':3,'equip':null,'hp':4,'id':0,'maxAp':30,'maxHp':4,'owner':1,'visualType':3,'x':1,'y':0}],'owner':1,'visualType':1,'x':1,'y':1},{'actions':[0,1,6,7,8,9],'category':1,'id':2,'items':[{'count':1,'type':1},{'count':10,'type':5}],'layer':2,'members':[{'actions':[0,1],'ap':4,'baseDefense':2,'basePower':2,'baseSkill':2,'equip':null,'hp':1,'id':0,'maxAp':30,'maxHp':1,'owner':2,'visualType':1,'x':2,'y':2},{'actions':[0,2],'ap':7,'baseDefense':1,'basePower':2,'baseSkill':3,'equip':null,'hp':4,'id':35,'maxAp':30,'maxHp':4,'owner':2,'visualType':3,'x':2,'y':3}],'owner':2,'visualType':6,'x':3,'y':2},{'actions':[0,1,6,7,8,9],'category':1,'id':3,'items':[{'count':1,'type':1},{'count':10,'type':5}],'layer':2,'members':[{'actions':[0,1],'ap':4,'baseDefense':2,'basePower':2,'baseSkill':2,'equip':null,'hp':1,'id':0,'maxAp':30,'maxHp':1,'owner':2,'visualType':1,'x':2,'y':2},{'actions':[0,2],'ap':0,'baseDefense':1,'basePower':2,'baseSkill':3,'equip':null,'hp':4,'id':13,'maxAp':30,'maxHp':4,'owner':2,'visualType':3,'x':2,'y':3}],'owner':2,'visualType':6,'x':1,'y':6},{'actions':[0,1,6,7,8,9],'category':1,'id':4,'items':[{'count':1,'type':1},{'count':10,'type':5}],'layer':2,'members':[{'actions':[0,1],'ap':7,'baseDefense':2,'basePower':2,'baseSkill':2,'equip':null,'hp':1,'id':0,'maxAp':30,'maxHp':1,'owner':2,'visualType':1,'x':2,'y':2},{'actions':[0,2],'ap':6,'baseDefense':1,'basePower':2,'baseSkill':3,'equip':null,'hp':4,'id':1,'maxAp':30,'maxHp':4,'owner':2,'visualType':3,'x':2,'y':3}],'owner':2,'visualType':6,'x':7,'y':1},{'actions':null,'category':2,'id':5,'items':[{'count':1,'type':1},{'count':1,'type':2},{'count':1,'type':3},{'count':1,'type':4},{'count':10,'type':5},{'count':1,'type':6},{'count':1,'type':7}],'layer':1,'members':null,'owner':1,'visualType':4,'x':0,'y':0},{'actions':null,'category':3,'id':6,'items':[{'count':1,'type':1},{'count':10,'type':5}],'layer':1,'members':null,'owner':1,'visualType':5,'x':0,'y':3}],'units':null}";
